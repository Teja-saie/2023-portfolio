  ...
  return (
    <div className='flex flex-col justify-center items-stretch'>
        ...
        <div className="flex font-medium text-lg justify-center gap-2 py-5 text-center">
            <Link to="#" className="hover:bg-third p-2 rounded-full text-white" target="_blank"><FaLinkedinIn/></Link>
            <Link to="#" className="hover:bg-third p-2 rounded-full text-white" target="_blank"><FaGithub/></Link>
            <Link to="#" className="hover:bg-third p-2 rounded-full text-white" target="_blank"><FaInstagram/></Link>
